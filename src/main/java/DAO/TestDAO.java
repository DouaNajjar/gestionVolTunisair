...
public class TestDAO {
    public static void main(String[] args) {
        ...
        Pilote p1=new Pilote("123456","Najjar","Yassine","yassine@",d,Boolean.TRUE);
        Pilote p2=new Pilote("123654","Mohsni","Sarra","Sarra@",d1,Boolean.TRUE);
        Pilote p3=new Pilote("147852","Zayani","Mohamed","Mohamed@",d2,Boolean.TRUE);
        //DAOPilote.ajouter(p1);
        //DAOPilote.ajouter(p2);
        //DAOPilote.ajouter(p3);
        //DAOPilote.supprimer(p1);
        MembreEquipage me1=new MembreEquipage("852963","Riahi","Nour","Nour@",d,Boolean.TRUE);
        MembreEquipage me2=new MembreEquipage("741852","Mkacher","Hiba","Hiba@",d2,Boolean.TRUE);
